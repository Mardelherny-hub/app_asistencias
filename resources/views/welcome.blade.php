...
<body class="antialiased bg-[#F5F6F8] font-sans min-h-screen">
    <div x-data="{ loading: true }" x-init="setTimeout(() => loading = false, 800)">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <nav class="flex justify-between items-center h-16 md:h-20">
                    ...
                    <a href="{{ Auth::check() ? route('dashboard') : route('login') }}" 
                        class="bg-white/10 text-white hover:text-gray-200 transition-colors duration-200 
                            px-4 py-2 rounded-lg hover:bg-white/20 focus:outline-none focus:ring-2 
                            focus:ring-white/50 text-sm md:text-base flex items-center">
                        @auth
                            <span class="mr-2">
        ...
        <div class="flex flex-col h-screen py-4">
            <!-- Main Content -->
            <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 md:pt-28 pb-12 flex-grow">
                <!-- Loading Skeleton -->
                                ...
                                <div class="space-y-3">
                                    <button @click="expanded = !expanded" 
                                        ...
                                        <div class="flex items-center justify-between">
                                            <h3 class="font-semibold text-[#3B4042] text-lg">Detalles</h3>
                                    ...
                                    <div x-data="{ showTalks: false }" class="mt-4">
                                        <button @click="showTalks = !showTalks" 
                                                class="w-full text-left focus:outline-none focus:ring-2 focus:ring-[#2C4D71] rounded-lg p-2 -mx-2">
                                            <div class="flex items-center justify-between">
                                                <h3 class="font-semibold text-[#3B4042] text-lg">Programa</h3>
